      ...
      if($nhanvien=='admin'){  
        ...
        $query="INSERT INTO quan_tri VALUES ('$id2','$ten','$gioitinh','$sdt','$diachi','$ten_hinh','$username','$pass')";
            ...
            if(mysqli_affected_rows($dbc)==1){
              $thongbao="<div class='alert alert-success' role='alert'>Đã đăng ký thành công !<script> setTimeout(function(){window.location='index-nhanvien.php';},2000);</script></div>";
            }else{
            ...
            <img src="images/icon2.png" class="avatar" style="left:200px">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="radio-button" style="display: flex;">
                            ...
                            <?php if(isset($_POST['nhanvien'])&&($_POST['nhanvien'])=="khachhang") echo 'checked'?> checked/>Khách Hàng
                    ...
                    <a href="index-nhanvien.php"><h4 style="margin: 0;">QUAY LẠI</h4></a>
