<?php 
    ...
    $us = $_GET['us'];
    // echo $us;
    $query="SELECT * FROM quan_tri WHERE username = '$us'";
    ...
    <div class="boder-box">
        <div class="row">
    <div class="col-lg-6"><img src="images/'.$row['anh_dai_dien'].'" style="border-radius: 50%;float:right;" width="100px" height="100px"></div>
    <div class="col-lg-6">
