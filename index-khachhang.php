    ...
    {   
     ...
     <legend>KHÁCH HÀNG</legend>
        ...
        while ($row = mysqli_fetch_array($result)){
            ...
            echo "<td>$row[4]</td>";
            echo "<td>$row[6]</td>";
            echo "<td><a class='edit-btn' href='details-khachhang.php?ma_kh=".$row[0]."'><abbr title='xem thông tin'><img src='images/details.png' width='20px' height='20px' /></abbr></a>|<a class='edit-btn' href='edit-khachhang?ma_kh=".$row[0]."'><abbr title='sửa thông tin'><img src='images/edit.png' width='20px' height='20px' /></abbr></a>|<a class='edit-btn' href='delete-khachhang.php?ma_kh=".$row[0]."'><abbr title='Xóa khách hàng'><img src='images/delete.png' width='20px' height='20px' /></abbr></a></td>";
            echo "</tr>";
            $stt+=1;
        }
        echo '</table>';
