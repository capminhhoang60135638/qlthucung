		...
		{	$rows=mysqli_num_rows($result);
			while($row=mysqli_fetch_array($result, MYSQLI_ASSOC))
			{
				echo '<table align="center">
					<tr>
						<td colspan="2" style="text-align: center; color: OrangeRed;"><h3>THÔNG TIN THÚ CƯNG<br>'.$row['ten_tc'].'</h3><td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td colspan="2"><a href="thucung.php" class="btn btn-success"><< Quay lại danh sách</a></td>
					</tr>
				</table>';
			}
		}
