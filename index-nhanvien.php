    ...
    {   
     ...
     <legend>NHÂN VIÊN</legend>
        ...
        while ($row = mysqli_fetch_array($result))
        {
            ...
            echo "<td>$row[4]</td>";
            echo "<td>$row[6]</td>";
            echo "<td><a class='edit-btn' href='details-nhanvien.php?ma_nv=".$row[0]."'><abbr title='xem thông tin'><img src='images/details.png' width='20px' height='20px' /></abbr></a>|<a class='edit-btn' href='edit-nhanvien.php?ma_nv=".$row[0]."'><abbr title='sửa thông tin'><img src='images/edit.png' width='20px' height='20px' /></abbr></a>|<a class='edit-btn' href='delete-nhanvien.php?ma_nv=".$row[0]."'><abbr title='Xóa nhân viên'><img src='images/delete.png' width='20px' height='20px' /></abbr></a></td>";
            echo "</tr>";
            $stt+=1;
        }
        echo '</table>';
